...
router.get('/nearby/:longitude/:latitude/:distance?', check_permissions('nearby'), api.events.get_nearby_events)
router.get('/:ids', check_permissions('read'), api.events.get_event);
